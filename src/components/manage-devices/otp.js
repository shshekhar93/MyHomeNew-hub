  ...
  return (
    <div>
      {otp && 
        <div className={css({
          ...
          <p className={css({ margin: '0 0 0.5rem' })}>
            Here's your temporary password, enter your username and OTP on your device to connect it to your account.
            </p>
          <p className={css({
      ...
      {generating?
        ...
        <>
          <Link to="#" onClick={generate}>Generate One Time Password (OTP)</Link>
