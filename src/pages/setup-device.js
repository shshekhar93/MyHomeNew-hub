...
import { InputLabel, InputLabelText, PageHeading, Select } from '../shared/base-components.js';
...
function SetupDevice() {
  ...
  return (
    <div className={css({
      ...
      {devicesArr.length === 0 ?
        <p>No devices pending setup!&nbsp;<Link to="#" onClick={reload}>Check again?</Link></p> :
        <>
          <InputLabel>
          ...
          {selectedDevice &&
            <div className={css({
              ...
              <ManageDeviceInput device={deviceObj} isNew={true} onSave={reload} />
            </div>
          }
        </>
      }
